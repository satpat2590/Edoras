...
try:
    from config import SCORER_WEIGHTS, SYMBOL_TIERS, TIER_QUALITY_SCORES, DB_PATH as _CONFIG_DB_PATH
except ImportError:
    SCORER_WEIGHTS = {
        "momentum": 0.25,
        "trend": 0.15,
...
class AdvancedScoringModel:
    ...
    def calculate_quality_score(self, symbol: str) -> float:
        ...
        quality = tier_score * 0.50 + sharpe_score * 0.30 + vol_ratio_score * 0.20
...
def test_scoring():
    ...
    scorer = AdvancedScoringModel(_CONFIG_DB_PATH)
