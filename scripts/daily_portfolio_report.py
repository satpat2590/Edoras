...
class DailyPortfolioReporter:
    ...
    def generate_telegram_report(self) -> str:
        ...
        report_lines.append("")
        report_lines.append("---")
        report_lines.append("_Generated by Argus • Coinbase Portfolio Analysis_")
    ...
    def send_via_telegram(self, report_text: str, target: str = None):
        ...
        try:
            ...
            import urllib.parse
            token = os.getenv("TELEGRAM_BOT_TOKEN", "8724014451:AAGpisAWj86i8qmkOtfb4mCBSpiPfZd0ROI")
...
def main():
    ...
    try:
        ...
        if args.auto_send:
            ...
            success = reporter.send_via_telegram(report, args.target)
            if success:
